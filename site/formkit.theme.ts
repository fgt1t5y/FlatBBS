...
const classes: Record<string, Record<string, boolean>> = {
  ...
  togglebuttons__input: {
    ...
    'group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-indigo-500':
      true,
    'group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-indigo-600':
      true,
    'group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-indigo-600':
      true,
    'dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-indigo-600':
      true,
    'dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-indigo-600':
      true,
    'dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-indigo-600':
      true,
    ...
    'group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-indigo-500':
      true,
    'group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-indigo-600':
      true,
    'group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-indigo-600':
      true,
    'dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-indigo-600':
      true,
    'dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-indigo-600':
      true,
    'dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-indigo-600':
      true,
  },
  transferlist__outer: {
    group: true,
