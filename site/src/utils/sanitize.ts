// Copy from https://github.com/natemoo-re/ultrahtml/blob/main/src/transformers/sanitize.ts
import { type ElementNode, ELEMENT_NODE, type Node, walkSync } from 'ultrahtml';
...
export function sanitize(opts?: SanitizeOptions) {
